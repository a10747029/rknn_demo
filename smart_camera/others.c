...
int do_deal_request(char command_buf[],int length)
{
	...
	switch(valid_command[6]){
		case TJSATL_FUNCTION_CODE_QUERY:                    //0x2F
            ...
            QueryToAck(flowId, TJSATL_FUNCTION_CODE_QUERY);
			printf("TJSATL_FUNCTION_CODE_QUERY\n");
			break;
		case TJSATL_FUNCTION_CODE_RECOVERY_DEFAULT_PARAM:   //0x30

            RecoveryDefaultParamToAck(flowId, TJSATL_FUNCTION_CODE_RECOVERY_DEFAULT_PARAM);
