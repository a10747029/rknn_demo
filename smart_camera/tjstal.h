...
#define TJSATL_FUNCTION_CODE_RECOVERY_DEFAULT_PARAM 	0x30
...
//内测 command list
#define TJSATL_FUNCTION_CODE_ALERT_UPDATE_FRAME         0xF0
...
extern pthread_mutex_t connectFlagLock;
extern WORD allFlowId;


extern int connectServerSuccessFlag;
...
typedef struct _base_info {
	...
	BYTE software_version[MAX_NAME_LEN];	
	BYTE machine_id_length;
	BYTE machine_id[MAX_NAME_LEN];	
